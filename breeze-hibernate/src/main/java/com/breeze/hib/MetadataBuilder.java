...
public class MetadataBuilder {
    ...
    /**
     * Build the Breeze metadata and then wrap it in a strongly typed wrapper.
     * The internal rawMetadata can be converted to JSON and sent to the Breeze
     * client.
     */
    ...
    void addClassProperties(ClassMetadata meta, ArrayList<HashMap<String, Object>> dataArrayList,
                ...
                for (int i = 0; i < compNames.length; i++) {
                    ...
                    if (!propType.isAssociationType()) {
                        ...
                        HashMap<String, Object> assProp = makeAssociationProperty(type,
                                (AssociationType) propType, compName,
        ...
        for (int i = 0; i < propNames.length; i++) {
            ...
            if (propType.isAssociationType()) {
                ...
                HashMap<String, Object> assProp = makeAssociationProperty(type, (AssociationType) propType, propName,
                        propColumnNames, relatedDataPropertyMap, false);
                navArrayList.add(assProp);
            }
        }
    }
     ...
     */
    private HashMap<String, Object> makeAssociationProperty(Class containingType, AssociationType propType, String propName,
            String columnNames, HashMap<String, HashMap<String, Object>> relatedDataPropertyMap, boolean isKey) {
