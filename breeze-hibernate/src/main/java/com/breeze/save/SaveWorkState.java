...
public class SaveWorkState {
    ...
    public Object getIdentifier(EntityInfo entityInfo) {
        return _contextProvider.getIdentifier(entityInfo);
    }
...
//    }
     ...
     */
    public void afterSaveEntities() throws EntityErrorsException {
    }
    ...
    public boolean removeEntity(Object entity) {
        ...
        for (EntityInfo entityInfo : entityInfos) {
            if (entityInfo.entity == entity) {
                ...
                _contextProvider.processRelationships(entityInfo, true);
                return true;
            }
        }
        return false;
    ...
    public EntityInfo addEntityInfo(EntityInfo entityInfo) {
        ...
        _contextProvider.processRelationships(entityInfo, false);
        return entityInfo;
    }
    ...
    private void addKeyMapping(EntityInfo entityInfo) {
        if (entityInfo.entityState == EntityState.Added) {
            ...
            Object id = _contextProvider.getIdentifier(entityInfo);
     ...
     * @return
     */
    protected List<KeyMapping> updateAutoGeneratedKeys() {
