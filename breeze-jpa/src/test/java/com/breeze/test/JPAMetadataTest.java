...
public class JPAMetadataTest extends TestCase {
    ...
    */
    ...
    public void testBuildMetadata() {
        System.out.println("pers: " + getClass().getResource("META-INF/persistence.xml"));        
        System.out.println("pers: " + getClass().getResource("persistence.xml"));        
        System.out.println("json: " + getClass().getResource("northwindib_metadata.json"));        
        
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("northwind");
        
        Metadata metadata = new JPAMetadata(emf);
        metadata.build();
