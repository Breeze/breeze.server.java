...
public class MetadataBuilder {
    ...
    Configuration getConfigurationFromRegistry(SessionFactory sessionFactory)
    {
        ...
        if (cfg == null)
        {
    		throw new RuntimeException("Unable to get the Configuration from the service registry.  Please provide the Configuration in the constructor.");
        }
