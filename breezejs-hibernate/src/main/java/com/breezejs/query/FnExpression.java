...
public class FnExpression extends Expression {
	...
	// first DataType in the list is the return type the rest are argument types;
	...
	static {
		...
		registerFn("substring", DataType.String, DataType.Int32, DataType.Int32);
		...
		registerFn("substringof", DataType.Boolean, DataType.String, DataType.String);
		registerFn("startsWith", DataType.Boolean, DataType.String, DataType.String);
		registerFn("endsWith", DataType.Boolean, DataType.String, DataType.String);
	}
